                ...
                <div className="container-fluid " >
                    <div className=" navbar-collapse text-sm" id="navbarDropdown">
                        <ul className="navbar-nav">
                            ...
                            <LinksInternos href="/Artigo" label="Artigos"/>
                            <LinksInternos href="/Sobre" label="Sobre"/>
                            <LinksExternos href="https://api.whatsapp.com/send?phone=993356505&text=Olá! Mensagem automática!" target="_blank" label = "Consultar"/>
                            <LinksExternos href="#footer" label = "Entrar em contato"/>
                            <LinksInternos href="/Parceiros" label="Parceiros"/>
                        </ul>
                    </div>
                </div>    
            </nav>
